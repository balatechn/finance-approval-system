...
export function getStatusColor(status: string): string {
  const colors: Record<string, string> = {
    ...
    PENDING_FINANCE_CONTROLLER: 'bg-yellow-100 text-yellow-800',
    PENDING_FINANCE_COORDINATOR: 'bg-teal-100 text-teal-800',
    PENDING_DIRECTOR: 'bg-purple-100 text-purple-800',
    PENDING_MD: 'bg-indigo-100 text-indigo-800',
...
export function getStatusLabel(status: string): string {
  const labels: Record<string, string> = {
    ...
    PENDING_FINANCE_CONTROLLER: 'Finance Controller',
    PENDING_FINANCE_COORDINATOR: 'Finance Co-Ordinator',
