  ...
  () => import("@/components/dashboard/dashboard-charts"),
  {
    ...
    loading: () => (
      <div className="grid gap-4 lg:grid-cols-2 animate-pulse">
        <div className="lg:col-span-2 rounded-lg border bg-white p-4"><div className="h-[200px] bg-gray-100 rounded" /></div>
        <div className="rounded-lg border bg-white p-4"><div className="h-[200px] bg-gray-100 rounded" /></div>
        <div className="rounded-lg border bg-white p-4"><div className="h-[200px] bg-gray-100 rounded" /></div>
      </div>
    ),
  }
