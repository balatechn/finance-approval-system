...
- **Real-Time Dashboard** — Role-specific dashboards with statistics, pending approvals, recent requests, and charts.
...
| Model | Description |
|---|---|
| **User** | System users with roles, departments, manager hierarchy |
...
The system supports 6 report types:
